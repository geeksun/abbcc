...
CREATE TABLE `cpgqxx` (
  ...
  `sqsj` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
insert  into `cpgqxx`(`hyjbxxid`,`cpgqxxid`,`xxlx`,`cpmc`,`cpshlm`,`xxbt`,`cpsxid`,`xxsm`,`tp1`,`tp2`,`tp3`,`xxyxq`,`jytjid`,`sqsj`,`sfyx`,`scsj`,`xxyxsj`) values (1,31,'1','111','124','供应',NULL,'1111',NULL,NULL,NULL,'1',NULL,'2009-03-12 23:27:46','2',NULL,'2009-03-26 23:23:09');
...
insert  into `cpgqxx_0`(`hyjbxxid`,`cpgqxxid`,`xxlx`,`cpmc`,`cpshlm`,`xxbt`,`cpsxid`,`xxsm`,`tp1`,`tp2`,`tp3`,`xxyxq`,`jytjid`,`sqsj`,`sfyx`,`scsj`,`xxyxsj`) values (1,31,'1','111','124','供应',NULL,'1111',NULL,NULL,NULL,'1',NULL,'2009-03-12 23:27:46','2',NULL,'2009-03-26 23:23:09');
...
insert  into `jytj`(`hyjbxxid`,`jytjid`,`cpgqxxid`,`jldw`,`cpdj`,`zxqdl`,`ghzl`,`fhqx`,`gyslc`) values (1,46,31,'1','1','1','1','10','1');
...
insert  into `jytj_0`(`hyjbxxid`,`jytjid`,`cpgqxxid`,`jldw`,`cpdj`,`zxqdl`,`ghzl`,`fhqx`,`gyslc`) values (1,46,31,'1','1','1','1','10','1');
...
CREATE TABLE `message` (
  ...
  `delStateTo` int(1) NOT NULL default '1',
  `delStateFrom` int(1) NOT NULL default '1',
  PRIMARY KEY  (`id`)
...
insert  into `product`(`id`,`tableName`,`cpgqxxIdFiled`,`idFiledName`,`otherFiledName`,`productTypeId`,`formName`,`propertyName`,`isNull`,`remark`,`unit`,`type`,`isShow`,`isHidden`,`state`,`createTime`,`productName`,`productType`) values (38,'product_table_22','cpgqxxid','id','f_0,f_1,f_2,f_3,f_4','124','f_0,f_1,f_2,f_3,f_4','呵呵,<a href=\"#\">嘿嘿</a>,下拉:1@无聊#2@高兴#4@很好,复选:1@无聊#2@高兴#4@很好,隐身','true,true,true,true,true',' , , , , ','mm,mm,mm,mm, ','text,text,select,checkbox,text','true,true,true,true,true','false,false,false,false,true',1,'2009-03-12 23:16:27','测试产品',0);

/*Table structure for table `product_table_22` */

DROP TABLE IF EXISTS `product_table_22`;

CREATE TABLE `product_table_22` (
  `id` int(11) NOT NULL auto_increment COMMENT '测试产品',
  `cpgqxxid` int(11) NOT NULL COMMENT '测试产品',
  `f_0` varchar(255) default NULL,
  `f_1` varchar(255) default NULL,
  `f_2` varchar(255) default NULL,
  `f_3` varchar(255) default NULL,
  `f_4` varchar(255) default NULL,
  `createtime` timestamp NOT NULL default CURRENT_TIMESTAMP,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=gbk;

/*Data for the table `product_table_22` */

insert  into `product_table_22`(`id`,`cpgqxxid`,`f_0`,`f_1`,`f_2`,`f_3`,`f_4`,`createtime`) values (1,31,'11','11','2','1,2','111','2009-03-12 23:27:46');
...
insert  into `producttype`(`id`,`parentid`,`name`,`typeid`,`type`,`isshow`,`createtime`,`priority`) values (112,0,'照明工业',NULL,1,2,'2009-01-28 19:31:52',1),(113,0,'电子元器件',NULL,1,2,'2009-02-14 10:08:59',1),(114,0,'传媒、广电',NULL,1,2,'2008-12-21 19:56:21',4),(115,0,'安全、防护',NULL,1,2,'2008-12-21 19:35:20',100),(116,0,'包装',NULL,1,2,'2008-12-21 19:54:24',2),(117,0,'纸业',NULL,1,2,'2008-12-21 19:35:28',100),(118,0,'办公、文教',NULL,1,2,'2008-12-21 19:35:25',100),(119,112,'白炽灯',NULL,1,2,'2008-12-21 20:01:40',0),(120,112,'冷光源',NULL,1,2,'2008-12-21 20:01:44',0),(121,112,'电光源材料',NULL,1,2,'2008-12-21 20:01:46',0),(122,112,'插座',NULL,1,2,'2008-12-21 20:01:49',0),(123,112,'其他未分类',NULL,1,2,'2009-01-28 19:32:09',0),(124,119,'彩色灯泡',NULL,1,2,'2008-12-21 20:02:54',0),(125,119,'摄影灯泡',NULL,1,2,'2008-12-21 20:02:59',0),(126,119,'微型灯泡',NULL,1,2,'2009-01-28 19:32:02',0),(127,119,'水下灯泡',NULL,1,2,'2009-01-28 19:32:04',0),(128,119,'其他白炽灯',NULL,1,2,'2009-01-28 19:32:06',100),(130,120,'得到',NULL,1,1,'0000-00-00 00:00:00',100),(131,0,'加工',NULL,1,1,'0000-00-00 00:00:00',100),(132,131,'卡类印刷',NULL,1,2,'2009-03-10 21:01:14',100),(133,131,'特种印刷',NULL,1,2,'2009-03-10 21:01:56',100),(134,131,'生活印刷加工',NULL,1,2,'2009-03-10 21:01:59',100),(135,132,'银行卡',NULL,1,2,'2009-03-10 21:02:52',100),(136,132,'会员卡',NULL,1,2,'2009-03-10 21:02:57',100),(137,0,'代理',NULL,1,1,'0000-00-00 00:00:00',100),(138,137,'橡塑代理加盟',NULL,1,2,'2009-03-10 21:19:29',100),(139,138,'呵呵',NULL,1,2,'2009-03-10 21:23:02',100),(140,0,'商务服务',NULL,1,1,'0000-00-00 00:00:00',100),(141,140,'网店装修',NULL,1,2,'2009-03-10 21:26:51',100),(142,141,'页面图片设计',NULL,1,2,'2009-03-10 21:26:55',100),(143,0,'项目合作',NULL,1,1,'0000-00-00 00:00:00',100),(144,143,' 转让',NULL,1,2,'2009-03-10 21:29:13',100),(145,144,'技术转让',NULL,1,2,'2009-03-10 21:29:34',100);
...
insert  into `pz`(`tablename`,`recnum`,`max_count`) values ('company_logo',0,0),('cpgqxx',31,31),('dljmsx',0,0),('fwsx',0,0),('gly',0,0),('gsjbxx',3,3),('gsxxxx',3,3),('honor',1,0),('hygrzl',0,0),('hygzjl',0,0),('hyjbxx',3,3),('hyjyjl',0,0),('hysh',0,0),('hzsx',0,0),('jghz',0,0),('jytj',46,44),('product_table',22,20),('technology',1,0),('wzjbxx',0,0),('xxsh',0,0),('zpxx',0,0);
