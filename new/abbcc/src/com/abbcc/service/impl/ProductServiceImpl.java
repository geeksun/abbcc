...
public class ProductServiceImpl extends BaseServiceImpl implements ProductService {
	...
	public List<Product> getAllProductList() throws AppException {
		try{
	...
	public List<Product> getProductList(int state) throws AppException {
		try{
			 
			return this.productDao.getProductList(state);
			}catch(Exception e){
				throw  new AppException(e);
			}
	}
	...
	public List getProductInfoList(int userId, String orderType, String productName, String auditType, String overdue,Pagination pagination) throws AppException {
		try { 
			...
			int count=this.cpgqxxDao.getCpgqxxCount(userId, orderType,productName,auditType ,null,overdue);
	...
	public int getAllProductInfoListCount(Integer userId) throws AppException {
		 
		return this.cpgqxxDao.getAllCpgqxxCount(userId.longValue());
	}

	public int getNewProductInfoListCount(Integer userId) throws AppException {
		return this.cpgqxxDao.getNewCpgqxxCount(userId.longValue());
	}

	public int getOverTimeProductInfoListCount(Integer userId) throws AppException {
		return (int) this.cpgqxxDao.getCpgqxxOverdueCount(userId.longValue());
	}
