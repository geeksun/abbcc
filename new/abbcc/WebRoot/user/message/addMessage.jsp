...
<html>
	...
	<head>
		<title>留言</title> 
		<LINK rev=stylesheet href="<%=path%>/css/mainframe.css" type=text/css
			rel=stylesheet>
		<LINK rev=stylesheet href="<%=path%>/css/content.css" type=text/css
			rel=stylesheet>
	</head>
	<body>
		<% 
			...
			<br><TABLE cellSpacing=0 cellPadding=0 align=left width="100%">
								<TBODY>
									...
									<TR>
										...
										<TD class=c>
											 <%=from_hyjbxx != null ? from_hyjbxx.getHydlm() : ""%>
