...
<html>
				...
				<TR>
					...
					<TD class=card_blank>
						<SPAN style="FLOAT: right; TEXT-ALIGN: right"><IMG
								height=15 src="<%=path%>/images/myali_icon01.gif"
								width=16 align=absMiddle>未读&nbsp;&nbsp; <IMG height=15
								src="<%=path%>/images/myali_icon02.gif" width=16
								align=absMiddle>已读&nbsp;&nbsp; <IMG height=15
								src="<%=path%>/images/myali_icon03.gif" width=16
 ...
 %> <IMG height=15
									src="<%=path%>/images/myali_icon01.gif" width=16
									align=absMiddle> <%
 } else if (state == AppConstants.MESSAGE_STATE_REPLAY) {
 %> <IMG height=15 src="<%=path%>/images/myali_icon03.gif" width=16
									align=absMiddle> <%
 }
 %> </SPAN> 
						...
						<TD class=list_lb_content>
							...
							<IMG id=alitalkImg1 style="CURSOR: pointer" height=16
								src="<%=path%>/images/myt_offline.gif" width=16
