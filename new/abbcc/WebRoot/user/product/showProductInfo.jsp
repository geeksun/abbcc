		...
		function showLeafChecked(originalRequest){
	  	...
	  	function checkSubmit(){
		    ...
		    if(!checkProduct()){
	  		...
	  		document.mainform.action="<%=path%>/productInfo.do?method=updateProductInfo";
													...
													<tr id="uploadImg2" style="display:none">
														<td colspan="3">
															...
															<span id="inputfile2"> <input type="file"
																	...
																	value="" /> 
																	  </span>	<input type="hidden"  id="uploadPicState2" name="uploadPicState2" value="none" />
									...
									<tr>
										...
										<td>
											<div class="s lh13 normal s2">
												...
												<a name="aegisAlipay6"></a><a href="<%=path%>/traceInfo.do?action=displayBasicInfo" target="_blank">点此修改</a>
											</div>
										</td>
									</tr>
