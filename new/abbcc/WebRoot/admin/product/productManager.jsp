	...
	<script language="JavaScript" type="text/javascript">
	  ...
	  <script language="JavaScript" type="text/javascript">
	  	function addProduct(){ 
    		  ...
    		  document.form_product.action="<%=path%>/admin/product.do?method=addProduct";
		...
		function managerProduct(){ 
		     var productType=document.form_product.productTypeId.value;
    		  ...
    		  document.form_product.action="<%=path%>/admin/product.do?method=productList";
			  document.form_product.submit();
			
		}  
		function productList(state){ 
		     
    		  document.form_product.action="<%=path%>/admin/product.do?method=productAllList&state="+state;
			  document.form_product.submit();
