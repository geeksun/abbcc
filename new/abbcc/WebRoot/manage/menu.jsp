...
<html>
  ...
  <body>
     <dl>
       ...
       <dl>
     	<dd><a href="<%=path%>/manage/product.do?method=productManager" target="right"> 产品管理</a></dd>
     	 
     	<dd><a href="<%=path%>/manage/productType.do?method=showProductType" target="right">产品类目管理</a></dd>
     	<dd><a href="<%=path%>/manage/product.do?method=productInfoList&auditType=<%=AppConstants.CPGQXX_SFYX_2 %>&overdue=<%=AppConstants.CPGOXX_UN_OVERDUE %>" target="right">供求信息管理</a></dd>
