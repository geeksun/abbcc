			...
			<tr>
				<td valign="top">
					<form name='form_proudctTypeMenu'>
						<table>
							<tr>
								<td><input type="radio" name="productTypeMenu" value="1"
			...
			<tr>
				<td>
					<form name="form_add" method='post'
						action="<%=path %>/manage/productType.do?method=addProductType">
						<table>
							<tr>
								<td>
									名称
			...
			<tr>
				<td id='editProductTypeId' style='display: block;'>
					<form name="form_update" method='post'
						action="<%=path%>/manage/productType.do?method=updateProductType">
						<table>
							<tr>
								<td>
									名称
			...
			<tr>
				<td id='editProductTypeId' style='display: block;'>
					<form name="form_delete" method='post'
						action="<%=path%>/manage/productType.do?method=deleteProductType">
						<table>
							<tr>
								<td>
									名称
