		...
		<form name="form_product" method="post" action="">
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
					...
					<td>
						<a href="<%=path %>/manage/product.do?method=updateProductState&productId=<%=id %>&productTypeId=<%=productTypeId %>">使用</a>
						<a href="<%=path %>/manage/product.do?method=showProduct&productId=<%=id %>"> 修改</a>
						<a href="<%=path %>/manage/product.do?method=deleteProduct&productId=<%=id %>&productTypeId=<%=productTypeId %>">删除</a>
