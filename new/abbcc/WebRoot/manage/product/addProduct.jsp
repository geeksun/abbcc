	...
	<script language="JavaScript" type="text/javascript">
			...
			var property="<table  width='100%' id='productTable"+count+"' >"+ 
							 "<tr>"+
						        ...
						        "<td align='center' width='10%' >"+ 
						             "<textarea id='property"+count+"' name='property'  size='17'  ></textarea>"+
		...
		function checkSumbit(){
			...
			if(checkValue())
			{
				...
				document.form_product.action="<%=path%>/manage/product.do?method=createProduct";
		...
		<form name="form_product" method="post" action="">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
					<td align="left">
						<p><b>产品说明:</b></p>
						<p><b>1.文本类型</b>，名称格式：可以是html代码，如：文本内容  或 < a href="#">文本内容< /a></p>
						<p><b>2.下拉类型</b>，名称格式：内容:1@下拉值#2@下拉值#4@下拉值。其中以#分割内容列表</p>
						<p>需要调整列表顺序时,移动 (1@下拉值)  到后面。如2@下拉值#4@下拉值#1@下拉值</p>
						<p>请不要修改@前的值,也不能添加重复的值</p>
						       
						<p><b>3.复选类型 </b>，名称格式同下拉类型</p>
