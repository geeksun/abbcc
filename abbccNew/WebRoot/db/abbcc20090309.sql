...
insert  into `cpgqxx`(`hyjbxxid`,`cpgqxxid`,`xxlx`,`cpmc`,`cpshlm`,`xxbt`,`cpsxid`,`xxsm`,`tp1`,`tp2`,`tp3`,`xxyxq`,`jytjid`,`sqsj`,`sfyx`,`scsj`,`xxyxsj`) values (1,22,'1','testeee','124','供应',NULL,'sssss','FC7F950A54204B26856DDAC682E.gif','153DA9783CA215358B0B0E44C66.gif','371C05D923BBF6CC4C62C82BFC2.jpg','5',NULL,'2009-03-08 21:18:38','1',NULL,'2009-07-29 20:59:55');
...
insert  into `product`(`id`,`tableName`,`cpgqxxIdFiled`,`idFiledName`,`otherFiledName`,`productTypeId`,`formName`,`propertyName`,`isNull`,`remark`,`unit`,`type`,`isShow`,`isHidden`,`state`,`createTime`,`productName`) values (17,'product_table_7','cpgqxxid','id','f_0,f_1,f_2,f_3','124','f_0,f_1,f_2,f_3','我们多,你么我,他们,大家2','true,true,true,false',',,,','mm,mm,mm,mm','text,text,text,text','true,true,true,true','false,false,false,true',1,'2009-01-29 12:26:17','呵呵寺'),(18,'product_table_9','cpgqxxid','id','f_0','124','f_0',' 瞧瞧','true','','mm','text','true','true',2,'2009-02-14 10:18:46','得到');
...
/*Table structure for table `product_table_9` */

DROP TABLE IF EXISTS `product_table_9`;

CREATE TABLE `product_table_9` (
  `id` int(11) NOT NULL auto_increment COMMENT '得到',
  `cpgqxxid` int(11) NOT NULL COMMENT '得到',
  `f_0` varchar(255) default NULL,
  `createtime` timestamp NOT NULL default CURRENT_TIMESTAMP,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=gbk;

/*Data for the table `product_table_9` */
...
insert  into `pz`(`tablename`,`recnum`,`max_count`) values ('company_logo',0,0),('cpgqxx',23,23),('dljmsx',0,0),('fwsx',0,0),('gly',0,0),('gsjbxx',3,3),('gsxxxx',3,3),('honor',1,0),('hygrzl',0,0),('hygzjl',0,0),('hyjbxx',3,3),('hyjyjl',0,0),('hysh',0,0),('hzsx',0,0),('jghz',0,0),('jytj',38,36),('product_table',9,7),('technology',1,0),('wzjbxx',0,0),('xxsh',0,0),('zpxx',0,0);
