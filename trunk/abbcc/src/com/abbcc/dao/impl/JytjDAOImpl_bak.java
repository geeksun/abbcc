...
public class JytjDAOImpl_bak extends BaseDaoImpl  {
	private static JytjDAOImpl_bak jytjdaoimpl = null;
	...
	public JytjDAOImpl_bak() {
		this.session = HibernateUtil.currentSession();
	}

	public static JytjDAOImpl_bak getInstance() {
		if (jytjdaoimpl == null) {
			jytjdaoimpl = new JytjDAOImpl_bak();
		}
		return jytjdaoimpl;
	}
