...
public class HyjbxxDAOImpl implements HyjbxxDAO {
	 ...
	 *  page?
	 */
	public int insert(Hyjbxx hyjbxx) throws Exception { 
		//   
	...
	public List findByName(String name) {
		session = HibernateSessionFactory.getSession();
		String hql = "select h.hydlm from Hyjbxx h where h.hydlm = ?";
	...
	public boolean findByProperty(String name, String pass) {
