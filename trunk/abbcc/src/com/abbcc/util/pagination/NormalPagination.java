...
public class NormalPagination extends Pagination {
	...
	public String getHtml(String servicePath) {
		...
		if (totalPage   >= 1) {
			html.append("<div align=\"right\">\n");
			if(this.isShowTotalResults()){
				html.append("总数: "+this.getTotalResults()+" 条 | 当前： 第"+this.getCurrentPage()+"页  共"+this.getTotalPage()+"页 |");
			}
			html .append("<img src='"+servicePath+"/images/pagination/navLeft.gif' width='14' height='16' alt='第一页' onclick='gotoPage(1)'>\n");
			html .append("<img src='"+servicePath+"/images/pagination/left.gif' width='16' height='16' alt='上一页'  onclick='gotoPage("
							+ this.getPreviousPage() + ")'>\n");
			html .append("<img src='"+servicePath+"/images/pagination/right.gif' width='16' height='16'  alt='下一页'     onclick='gotoPage("
							+ this.getNextPage() + ")'>\n");
			html .append("<img src='"+servicePath+"/images/pagination/navRight.gif' width='14' height='16'  alt='最后一页'  onclick='gotoPage("
							+ totalPage + ")'>\n");
