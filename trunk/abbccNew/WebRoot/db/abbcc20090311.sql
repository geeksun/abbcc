...
insert  into `cpgqxx`(`hyjbxxid`,`cpgqxxid`,`xxlx`,`cpmc`,`cpshlm`,`xxbt`,`cpsxid`,`xxsm`,`tp1`,`tp2`,`tp3`,`xxyxq`,`jytjid`,`sqsj`,`sfyx`,`scsj`,`xxyxsj`) values (1,27,'1','ddd','124','供应',NULL,'ddd',NULL,NULL,NULL,'1',NULL,'2009-03-10 23:27:26','2',NULL,'2009-03-20 23:27:26'),(1,26,'1','ddd','124','供应',NULL,'ddd',NULL,NULL,NULL,'1',NULL,'2009-03-10 23:25:03','2',NULL,'2009-03-20 23:25:03');
...
insert  into `jytj`(`hyjbxxid`,`jytjid`,`cpgqxxid`,`jldw`,`cpdj`,`zxqdl`,`ghzl`,`fhqx`,`gyslc`) values (1,39,24,'11','111','11','111','10','2'),(1,40,25,'1','1','1','1','10','2'),(1,41,26,'12','22','22','22','10','1'),(1,42,27,'12','22','22','22','10','1');
...
insert  into `jytj_0`(`hyjbxxid`,`jytjid`,`cpgqxxid`,`jldw`,`cpdj`,`zxqdl`,`ghzl`,`fhqx`,`gyslc`) values (1,39,24,'11','111','11','111','10','2'),(1,40,25,'1','1','1','1','10','2'),(1,41,26,'12','22','22','22','10','1'),(1,42,27,'12','22','22','22','10','1');
...
insert  into `product`(`id`,`tableName`,`cpgqxxIdFiled`,`idFiledName`,`otherFiledName`,`productTypeId`,`formName`,`propertyName`,`isNull`,`remark`,`unit`,`type`,`isShow`,`isHidden`,`state`,`createTime`,`productName`) values (24,'product_table_15','cpgqxxid','id','f_0','124','f_0','ss:ddd#ddd#ddd','true','','mm','checkbox','true','false',1,'2009-03-10 23:23:09','sss');

/*Table structure for table `product_table_15` */

DROP TABLE IF EXISTS `product_table_15`;

CREATE TABLE `product_table_15` (
  `id` int(11) NOT NULL auto_increment COMMENT 'sss',
  `cpgqxxid` int(11) NOT NULL COMMENT 'sss',
  `f_0` varchar(255) default NULL,
  `createtime` timestamp NOT NULL default CURRENT_TIMESTAMP,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=gbk;

/*Data for the table `product_table_15` */

insert  into `product_table_15`(`id`,`cpgqxxid`,`f_0`,`createtime`) values (2,27,'1,1','2009-03-10 23:27:26');
...
insert  into `pz`(`tablename`,`recnum`,`max_count`) values ('company_logo',0,0),('cpgqxx',27,27),('dljmsx',0,0),('fwsx',0,0),('gly',0,0),('gsjbxx',3,3),('gsxxxx',3,3),('honor',1,0),('hygrzl',0,0),('hygzjl',0,0),('hyjbxx',3,3),('hyjyjl',0,0),('hysh',0,0),('hzsx',0,0),('jghz',0,0),('jytj',42,40),('product_table',15,13),('technology',1,0),('wzjbxx',0,0),('xxsh',0,0),('zpxx',0,0);
