...
<table border=0 cellPadding=3 cellSpacing=1 width="735" align="center">
  <tr>    
    ...
    <td>关键字:<input type="text" name="SearchText" size="25">未登录天数
      <select name="days">
      ...
      <select name="inquery">
	  <option value="" selected>咨询情况</option>
	  <option value="1">有咨询</option>
	  <option value="2">有未读咨询</option>
    ...
    <td vAlign=top>   
	  <table border=1 bordercolor=#111111 bordercolordark=#acd6ff bordercolorlight=#acd6ff cellpadding=3 cellspacing=1 height=50 width="100%">
        <tr height=25 bgcolor="#e8f4ff">
          <td width="32" align="center" bgcolor=#ddeeff><a href="yp_serve.asp?orderflag=landcous&[]">ID号</a></td>
          <td width="186" align="center" bgcolor=#ddeeff>公司名称</td>
          <td width="61" align="center" bgcolor=#ddeeff>日常邮件</td>
          <td width="54" align="center" bgcolor=#ddeeff>发送登录通知</td>
          <td width="50" align="center" bgcolor=#ddeeff>未登录天数</td>
          <td width="34" align="center" bgcolor=#ddeeff>日志</td>
          <td width="39" align="center" bgcolor=#ddeeff>客户咨询</td>
          <td width="37" align="center" bgcolor=#ddeeff><a href="yp_serve.asp?orderflag=landcous&[]">登陆次数</a></td>
          <td width="61" align="center" bgcolor=#ddeeff>最后登录时间</td>
          <td width="88" align="center" bgcolor=#ddeeff>登录IP</td>
        </tr>
        <tr height="20" bgcolor="#ffffff">
          <td width="32" align="center"><font face="Arial">[]</font></td>
          <td width="186"><a href=edit.asp?id=[]&menu=4>[]</a></td>
          <td width="61" align=center><a href="sendfriend.asp?id=[]">发送</a></td>
          <td width="54" align=center><a href="inform.asp?id=[]">发送</a></td>
          <td width="50" align="center">[]天</td>
          <td width="34" align="center"> <a href='mem_log.asp?m_id=[]'>日志</a></td>
          <td width="39" align="center"> <a href="inquery.asp?m_id=[]">咨询</a></td>
...
<table width="735" height="30" border="0" align="center" cellPadding="0" cellSpacing="0" bgcolor="#EBEBEB" class="serchcss">
    ...
    <tr>
      ...
      <td width="33%" align="center">&nbsp;&nbsp;直接到
          <input name="pageno" size="5" maxlength="10">&nbsp;页&nbsp;
