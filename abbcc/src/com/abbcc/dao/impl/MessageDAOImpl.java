...
public class MessageDAOImpl extends BaseDaoImpl implements MessageDAO {
	...
	public List getSellMessage(int fromid, int time, int _state, int type,
			int start, int end) {
		String sql = "from Message m where m.fromid=?" + "and m.type=? ";
	...
	public List getBuyMessage(int fromId, int time, int _state, int type,
			int start, int end) {
		String sql = "from Message m where m.fromid=?" + "and m.type=? ";
		Calendar rightNow = Calendar.getInstance();
		if (time == 1) {
	...
	public List getMessageAll(int fromId, int time, int _state, int start,
			int end) {
	...
	public List getMessageList(Integer fromId, Integer toId, Integer state,
			Integer type, Date startTime, Date endTime, int start, int end) {
		try {
