	...
	if (number!=-1)
		{
			if (i==-1)
				...
				document.all("outlooktitle"+i).style.background="#ACD6FF";
			...
			document.all("outlooktitle"+number).style.background="#ACD6FF"; //title
	...
	for (i=0;i<(outlookbar.titlelist.length);i++)
		{
			...
			if (i!=outlookbar.opentitle) 
				outline+=" nowrap align=center style='cursor:hand;background-color:#ACD6FF;color:#ffffff;height:5;border:1 none navy' ";
			else
				outline+=" nowrap align=center style='cursor:hand;background-color:#ACD6FF;color:white;height:5;border:1 none white' ";
			...
			<tr>
				<td valign="top">
					<table id=mnuList style="WIDTH: 140px; HEIGHT: 100%" cellspacing=0
						...
						<tr>
							<td bgcolor=#EEF7FF id=outLookBarShow style="HEIGHT: 100%"
				...
				<td width="16" bgcolor=#FFFFFF background="menu_bg_02.gif">
