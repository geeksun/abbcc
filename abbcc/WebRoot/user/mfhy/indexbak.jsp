...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript"
			src="http://style.china.abbcc.com/js/alicn/alitalk2.js?version=6.0"></script>
		<script type="text/javascript"
			src="http://style.china.abbcc.com/js/common/search/search.js"
			charset="gb2312"></script>
		<script type="text/javascript"
			src="http://style.china.abbcc.com/js/myabbcc/AlicnTree/AlicnTree.js?t=0702"></script>
		<link rel="stylesheet" rev="stylesheet"
			href="http://style.china.abbcc.com/js/myabbcc/AlicnTree/AlicnTree.css?t=0719"
			type="text/css" />
		<link rel="stylesheet" rev="stylesheet"
			href="http://style.china.abbcc.com/css/common/search/myali_search_v02.css"
			type="text/css" />
		<link rel="stylesheet" rev="stylesheet"
			href="http://style.china.abbcc.com/css/myabbcc/mainframe.css?t=0720"
			type="text/css" />
		<script language="JavaScript"
			src="http://i03.c.aliimg.com/stat/aliclick.js"></script>
		<script type="text/javascript">
var roots = {menu:[
	{id:"0",name:"阿里助手首页", url: "http://china.abbcc.com/member/myabbcc.htm?ca=true&tracelog=myali_menu_home" , children:[]},
			{id:"1",name:"供求信息",children:
		[		
    		{id:"1.1.1",name:"发布供求信息",url:"http://china.abbcc.com/offer/offer_post.htm?tracelog=myabbcc_fb_inyitihua", children:[]},
    		{id:"1.1.3",name:"批量发布信息",url:"http://china.abbcc.com/offer/batch_post_offer.htm?tracelog=myabbcc_pftoolbar", children:[]},
			{id:"1.1.2",name:"管理供求信息",url:"http://china.abbcc.com/offer/manage.htm?tracelog=myali_menu_manageoffer", children:[]},
			{id:"1.1.4",name:"信息自定义分类",url:"http://china.abbcc.com/offer/manage_offer_group.htm?tracelog=fb_offer_group", children:[]},
    		{id:"2.3",name:"订阅商机快递",children:[
    			{id:"2.3.1",name:"订阅供求信息",url:"http://china.abbcc.com/bizexpress/advance_search.htm?isTakingEmail=y&tracelog=myali_menu_subscribenews", children:[]},
    			{id:"2.3.4",name:"订阅商业资讯",url:"http://china.abbcc.com/bizexpress/info.htm", children:[]},	
				{id:"2.3.2",name:"管理商机快递",url:"http://china.abbcc.com/bizexpress/my_searcher.htm?tracelog=myali_menu_subscribemanage", children:[]},	
				{id:"2.3.3",name:"在线商机快递",url:"http://china.abbcc.com/bizexpress/web_biz_express.htm?tracelog=myali_menu_messageonline", children:[]}
			]},
			{id:"2.4",name:"我的收藏",url:"http://athena.china.abbcc.com/favorites/favorites_list.htm?tracelog=myali_menu_collection", children:[]}			
		]},
	{id:"1.3",name:"公司介绍",url:"http://china.abbcc.com/company/my_company.htm?tracelog=myali_menu_company_intro",  children:[]},
	{id:"2",name:"留言和邮箱",children:
		[
    		{id:"2.1.1",name:"我收到的留言",url:"http://china.abbcc.com/message/list_received_message.htm?ml=1&tracelog=myali_menu_myreceivedmessage", children:[]},
    		{id:"2.1.2",name:"我发出的留言",url:"http://china.abbcc.com/message/list_sent_message.htm?tracelog=myali_menu_mysendmessage", children:[]},	
    		{id:"2.1.3",name:"垃圾留言",url:"http://china.abbcc.com/message/list_spam_message.htm?tracelog=myali_menu_myrubbishmessage", children:[]},
    		{id:"2.2",name:"阿里邮箱",url:"http://china.abbcc.com/misc/ymail/tpMailLogin.htm",aliclick:"myali_menu_otpmail",target:"_blank", children:[]}
		]
	},
	
	{id:"3",name:"会员资料",children:
		[
			{id:"3.1",name:"修改联系信息",url:"http://china.abbcc.com/member/modify_member_info.htm?ml=1&tracelog=myali_menu_modifyinfo", children:[]},
			{id:"3.2",name:"手机验证",url:"http://china.abbcc.com/message/mobile_manage.htm?tracelog=myali_menu_mobilevalidate", children:[]},
			{id:"3.3",name:"修改密码",url:"http://china.abbcc.com/member/modify_password.htm?tracelog=myali_menu_modifypassword", children:[]}
		]
	},
	
	{id:"7",name:"竞价排名",children:
		[
		{id:"7.1",name:"参加竞价",url:"http://athena.china.abbcc.com/keyword/search_keyword.htm?tracelog=myali_menu_searchkeyword", children:[]},
		{id:"7.2",name:"我的竞价情况",url:"http://athena.china.abbcc.com/keyword/my_bidding.htm?tracelog=myali_menu_mybiddingok",children:[]},
		{id:"7.3",name:"账户与付款",children:[
		    {id:"7.3.1",name:"账户明细",url:"http://athena.china.abbcc.com/keyword/view_account_details.htm?tracelog=myali_menu_viewaccountdetails", children:[]},
			{id:"7.3.2",name:"红包账户",url:"http://athena.china.abbcc.com/keyword/view_bonus.htm?tracelog=myali_menu_viewbonus", children:[]},	
			{id:"7.3.3",name:"付款方式",url:"http://athena.china.abbcc.com/keyword/pay_view.htm?tracelog=myali_menu_payview", children:[]}
		]},
		{id:"7.4",name:"竞价信息投放",url:"http://athena.china.abbcc.com/keyword/putin_info_manager.htm?tracelog=myali_menu_mybiddingon", children:[]}
		]
	},
	{id:"13",name:"点击推广",statusIcon:"http://i01.c.aliimg.com/images/cn/home/070214/new_l.gif",url:"http://china.abbcc.com/member/my_bidding.htm", children:[]},
	{id:"1.4",name:"诚信通档案",children:[
		{id:"1.4.1",name:"客户评价",url:"http://athena.china.abbcc.com/athena/trade_remark_manager.htm?remark_action=receivedRemark&tracelog=myali_menu_customer_estimate", children:[]},
		{id:"1.4.2",name:"我的证书",url:"http://athena.china.abbcc.com/athena/list_certificate.htm?tracelog=myali_menu_mycertificate", children:[]},
		{id:"1.4.3",name:"资信参考人",url:"http://athena.china.abbcc.com/athena/list_referral.htm?tracelog=myali_menu_referenceman", children:[]}
	]},    
	...
	{id:"4",name:"在线拍卖",children:
		[
			{id:"4.1",name:"我要拍卖物品",url:"http://auction.china.abbcc.com/myauction/post.htm?tracelog=myali_menu_myauctionfor", children:[]},
			{id:"4.2",name:"我发起的拍卖",url:"http://auction.china.abbcc.com/myauction/my_auctions.htm?tracelog=myali_menu_myauctions", children:[]},
			{id:"4.3",name:"我参与的拍卖",url:"http://auction.china.abbcc.com/myauction/participate_auctions.htm?tracelog=myali_menu_participateauctions", children:[]}
		]
	},
	...
	{id:"6",name:"支付宝账户",children:
		[
			{id:"6.1",name:"支付宝账户",url:"http://china.abbcc.com/member/alipay_manager.htm?tracelog=myali_menu_myalipay", children:[]}
		]
	},
	 ...
	 {id:"10",name:"社区",children:
		[
			{id:"10.1",name:"我的社区留言",url:"http://club.china.abbcc.com/message/pmsg/list/inbox___.html?tracelog=myali_menu_myclubmessage",target:"_blank", children:[]},
			{id:"10.2",name:"我的论坛文章",url:"http://club.china.abbcc.com/user/myArticles/yys580_0_1_.html?tracelog=myali_menu_myclubarticle",target:"_blank", children:[]},
			{id:"10.3",name:"我的论坛收藏",url:"http://blog.china.abbcc.com/blog/yys580/bookmark.html?tracelog=myali_menu_myclubcollection",target:"_blank", children:[]},
			{id:"10.1",name:"我的论坛设置",url:"http://club.china.abbcc.com/user/my_setting.html?tracelog=myali_menu_myclubset",target:"_blank", children:[]},
			{id:"10.2",name:"我的个人博客",url:"http://yys580.blog.china.abbcc.com?tracelog=myali_menu_myblog",target:"_blank", children:[]},
			{id:"10.3",name:"我的博客管理",url:"http://blog.china.abbcc.com/bizblog/admin_home.html?tracelog=myali_menu_myblogmanage",target:"_blank", children:[]}
		]
	},
