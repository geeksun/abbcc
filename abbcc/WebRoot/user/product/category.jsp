...
<html>
	...
	<script language="JavaScript" type="text/javascript">
 		function gotoProduct(name)
 		{
 			...
 			window.open("<%=path%>/productInfo.do?method=showProductInfo","right");
 		}
 		
 		function gotoPostPage(name,productTypeId)
 		{
 		    var id = productTypeId; 
 		    //alert(""+id);
 			window.open("<%=path%>/productInfo.do?method=showCategoryProductInfo&productTypeId="+id,"right");
 		}
	</script>
...
<table> 
	<tr>
		<td>
			<table onclick="gotoProduct('product')" class=Gbox_off id=Gbox1>
				<tr >
		...
		<td>
			<table onclick="gotoPostPage('product','131')" class=Gbox_off id=Gbox1>
				<tr>
					<td><IMG src="<%=path%>/images/icon0.gif"></td>
					<td>提供加工、寻求加工信息。 </td>
				</tr>
	...
	<tr>
		<td>
			<table onclick="gotoPostPage('product','137')" class=Gbox_off id=Gbox1>
				<tr>
		...
		<td>
			<table onclick="gotoPostPage('product','140')" class=Gbox_off id=Gbox1>
				<tr>
		...
		<td>
			<table onclick="gotoPostPage('product','143')" class=Gbox_off id=Gbox1>
				<tr>
