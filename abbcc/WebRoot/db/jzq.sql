...
insert  into `gsjbxx`(`hyjbxxid`,`gsmc`,`qylx`,`jyms`,`gsszd`,`jydz`,`zyhy`,`zyfx`,`xsdcp`,`cgdcp`,`gsjs`) values (2,'中国集团','10','','北京','北江','127,128,131,125,126,124,','3','电子','软件','    		\r\n    		\r\n    		'),(3,'adidas','10','1','china hebei','河北','010202','2','衩子','白菜',NULL);
...
insert  into `gsjbxx_0`(`hyjbxxid`,`gsmc`,`qylx`,`jyms`,`gsszd`,`jydz`,`zyhy`,`zyfx`,`xsdcp`,`cgdcp`,`gsjs`) values (2,'中国集团','10','','北京','北江','127,128,131,125,126,124,','3','电子','软件','    		\r\n    		\r\n    		'),(3,'adidas','10','1','china hebei','河北','010202','2','衩子','白菜',NULL);
...
insert  into `pz`(`tablename`,`recnum`,`max_count`) values ('cpgqxx',27,19),('dljmsx',0,0),('fwsx',0,0),('gly',0,0),('gsjbxx',4,4),('gsxxxx',0,0),('hygrzl',0,0),('hygzjl',0,0),('hyjbxx',4,4),('hyjyjl',0,0),('hysh',0,0),('hzsx',0,0),('jghz',0,0),('jytj',15,13),('product_table',4,2),('wzjbxx',0,0),('xxsh',0,0),('zpxx',0,0);
